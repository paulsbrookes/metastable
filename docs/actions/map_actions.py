...
path = Path("/home/paul/Projects/misc/keldysh/metastable/docs/paths/examples/output/8/output_map.npz")
fixed_point_map = FixedPointMap.load(path)

fixed_point_map_with_actions = map_actions(fixed_point_map)

output_path = Path("/home/paul/Projects/misc/keldysh/metastable/docs/paths/examples/output/8/output_map_with_actions.npz")
