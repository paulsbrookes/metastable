...
fig, (ax0, ax1) = plt.subplots(2, 1, figsize=(17, 10), height_ratios=[1, 1], sharex=True)
...
dykman_actions_bright_to_saddle = pd.read_parquet('dykman_actions_bright_to_saddle.parquet')
...
for df in [actions_bright_to_saddle, actions_dim_to_saddle, dykman_actions_bright_to_saddle, dykman_actions_dim_to_saddle]:
...
ax0.plot(fixed_point_map.kappa_linspace / delta, epsilon_limits_array[0] / delta, color='red', label='Unstable-Bright', linewidth=lw)
ax0.plot(fixed_point_map.kappa_linspace / delta, epsilon_limits_array[1] / delta, color='blue', label='Unstable-Dim', linewidth=lw)
...
ax1.plot(actions_bright_to_saddle.index, -actions_bright_to_saddle.values, linewidth=lw, color='red')
ax1.plot(actions_dim_to_saddle.index, -actions_dim_to_saddle.values, linewidth=lw, color='blue')
ax1.plot(dykman_actions_bright_to_saddle.index, -dykman_actions_bright_to_saddle.values, linewidth=lw, color="purple", ls='-.')
ax1.plot(dykman_actions_dim_to_saddle.index, -dykman_actions_dim_to_saddle.values, linewidth=lw, color="green", ls='-.')
