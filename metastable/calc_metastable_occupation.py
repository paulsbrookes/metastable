import scipy
from qutip import parallel_map, wigner, tracedist, qload, fock_dm, tensor, destroy, qeye, expect
import numpy as np
...
def p_b_calc(rho_ss, rho_b, rho_d):
    res = scipy.optimize.minimize_scalar(overlap_objective, args=(rho_ss, rho_b, rho_d), method='brent')
    return res.x