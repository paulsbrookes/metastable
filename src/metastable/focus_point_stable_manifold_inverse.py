...
def calculate_focus_point_stable_manifold_inverse(
    classical_focus_point: NDArray[float], params: Params
) -> NDArray[float]:
    ...
    keldysh_saddle_point = extend_to_keldysh_state(classical_focus_point)
