...
def generate_boundary_condition_func(keldysh_saddle_point: NDArray, keldysh_focus_point: NDArray, params: Params) -> Callable[[NDArray, NDArray], NDArray]:
    ...
    focus_point_bc_vectors = focus_point_stable_manifold_inverse + np.dot(np.array([[0, 1], [-1, 0]]),
